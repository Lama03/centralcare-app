        ...
        <div class="table-filters col-md-12 mb-4">
            <div class="row mb-4">
                ...
                <div class="form-group col-md-2 mb-1">
                        ...
                        <select class="form-control" v-model="source_filter">
                            <option value="">--Select--</option>
                ...
                <div class="form-group col-md-2 mt-4 mb-1" style="margin-top: 30px !important;">
                    <div class="input-group  d-xl-inline-flex">
                        <a class="btn btn-success" :href="route('admin.leads.export', {page: page ,date_from: date_from,date_to: date_to,status_filter: status_filter,source_filter: source_filter, q: q})" title="New" style="width: 100%;">Export</i></a>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <table class="table table-responsive-md text-small">
                            ...
                            <tbody>
                                <tr v-for="lead in leads.data">
                                    ...
                                    <td>{{ lead.name }}</td>
                                    <td>{{ lead.phone}}</td>
                                    <td>{{ lead.branche.name }}</td>
                                    <td>{{ lead.doctor.name }}</td>
                                    <td>{{ lead.source }}</td>
                                    <td>
                                        <span v-bind:class="{ 'badge-success' : (lead.sent === 1) , 'badge-light' : (lead.sent === 0) , 'badge-danger' : (lead.sent === 2) , 'badge-success' : (lead.sent === 3) }" class="badge">{{ lead.sentLabel }}</span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" :href="route('admin.leads.confirmed', {lead: lead.id, page: page})">Confirmed</a>
                                                <a class="dropdown-item" :href="route('admin.leads.unconfirmed', {lead: lead.id, page: page})">Not Confirmed</a>
                                                <a v-if="lead.source == 'free-services'" class="dropdown-item" :href="route('admin.leads.winner', {lead: lead.id, page: page})">Winner</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
