                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.discount-categories.store') }}">
                                @method('POST')
                                @csrf
                                ...
                                <div class="form-row " style="margin-bottom:  10px">
                                    <div class="default-tab " style="width: 100%">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            @endforeach
                                            <!-- @include('admin.layout.field', field('text', 'slug', 'Slug', 6, [], ['key' => 'slug'])) -->
                                            <div class="form-group col-md-6 @error('slug') has-danger @enderror">
                                                <label for="price_id"> slug<span class="text-danger">*</span></label>
                                                <input type="text" id="price_id" name="slug" placeholder="Enter slug" value="{{ old('slug') }}" class="form-control" />
                                ...
                                <!-- @include('admin.layout.field', field('select', 'branche_id', 'Branches', 12, [], $branches, true, true)) -->
