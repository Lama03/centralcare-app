    ...
    <section class="thanks d-pad">
        <div class="container">
            ...
            <div class="section-title">
                {!! settings()->get('thanks.title.page') !!}
                ...
                <a href="{{ route('web.home.index', app()->getLocale() != 'ar' ? ['lang' => app()->getLocale()] : '') }}" class="btn btn-brand-primary-5" data-aos="fade-up" data-aos-delay="200">
                    {{ __('messages.Home') }}
                </a>
            </div>
            <!-- // title -->
