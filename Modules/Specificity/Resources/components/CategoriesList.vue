            ...
            <div class="row">
                ...
                <div class="col-md-1 col-sm-3 mb-1">
                    <div class="input-group  d-xl-inline-flex">
                        <a class="btn btn-success" :href="route('admin.categories.create')" title="New"><i class="la la-plus"></i></a>
                    </div>
                </div>
                        ...
                        <table class="table table-responsive-md text-small">
                            ...
                            <tbody>
                                <tr v-for="category in categories.data">
                                    ...
                                    <td>{{ category.name }}</td>
                                    <td>{{ category.specificity.name }}</td>
                                    <td>
                                        <span v-bind:class="{ 'badge-success' : (category.status === 2) , 'badge-light' : (category.status === 1) }" class="badge">{{ category.statusLabel }}</span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" :href="route('admin.categories.edit', {category: category.id, category: category})">Edit</a>
                                                <a class="dropdown-item" :href="route('admin.categories.enable', {category: category.id, page: page})">Enable</a>
                                                <a class="dropdown-item" :href="route('admin.categories.disable', {category: category.id, page: page})">Disable</a>
                                                 <a class="dropdown-item" :href="route('admin.categories.delete', {category: category.id, page: page})">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
