                        ...
                        <table class="table table-responsive-md text-small">
                            ...
                            <tbody>
                                <tr v-for="blog in blogs.data">
                                    ...
                                    <td>{{ blog.name }}</td>
                                    <td>
                                        <span v-bind:class="{ 'badge-success' : (blog.status === 2) , 'badge-light' : (blog.status === 1) }" class="badge">{{ blog.statusLabel }}</span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" :href="route('admin.blogs.edit', {blog: blog.id, blog: blog})">Edit</a>
                                                <a class="dropdown-item" :href="route('admin.blogs.enable', {blog: blog.id, page: page})">Enable</a>
                                                <a class="dropdown-item" :href="route('admin.blogs.disable', {blog: blog.id, page: page})">Disable</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
