            ...
            <div class="row">
                ...
                <div class="col-md-1 col-sm-3 mb-1">
                    <div class="input-group  d-xl-inline-flex">
                        <a class="btn btn-success" :href="route('admin.blog-categories.create')" title="New"><i class="la la-plus"></i></a>
                    </div>
                </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" :href="route('admin.blog-categories.edit', {blog_category: category.id, blog_category: category})">Edit</a>
                                                <a class="dropdown-item" :href="route('admin.blog-categories.enable', {blog_category: category.id, blog_category: category})">Enable</a>
                                                <a class="dropdown-item" :href="route('admin.blog-categories.disable', {blog_category: category.id, blog_category: category})">Disable</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
export default {
    ...
    methods: {
        fetchCategories(page = 1) {
            this.page = page;
            axios
                .get(route('api.blog.categories.index', {
                    page: page,
                    q : this.q,
                    sort : this.sort.id,
