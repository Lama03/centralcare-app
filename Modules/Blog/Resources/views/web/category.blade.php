...
<div class="simple-background">
    ...
    @include('web.components.page_header', ['page_name' => ( $articlecat->meta_title ? $articlecat->meta_title : __('messages.Central Care Blog') )])
                    ...
                    <div class="col-12 col-md-6">
                        <div class="section-title flex-column align-items-start mb-0">
                            <h2 class="title" data-aos="fade-up">
                             ...
                             {{ $articlecat->meta_title ? $articlecat->meta_title : __('messages.Central Care Blog')}}
                            </h2>
                            <div class="sub-desc">
