                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.sliders.update', ['slider' => $form->id]) }}">
                                @method('PUT')
                                @csrf
                                                    ...
                                                    <div class="pt-4">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input name="{{ $locale }}[first_title]"
                                                                   value="{{ $form->translate($locale)->first_title ?? '' }}"
                                                                   class="form-control" />
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input name="{{ $locale }}[second_title]"
                                                                   value="{{ $form->translate($locale)->second_title ?? '' }}"
                                                                   class="form-control" />
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea id="input_page_name"
                                                                      ...
                                                                      class="form-control"
                                                                      rows="10">{{ $form->translate($locale)->description ?? '' }}</textarea>
