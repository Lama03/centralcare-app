            ...
            <div class="row">
                ...
                <div class="col-md-1 col-sm-3 mb-1">
                    <div class="input-group  d-xl-inline-flex">
                        <a class="btn btn-success" :href="route('admin.news-categories.create')" title="New"><i class="la la-plus"></i></a>
                    </div>
                </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" :href="route('admin.news-categories.edit', {news_category: category.id, news_category: category})">Edit</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
export default {
    ...
    methods: {
        fetchCategories(page = 1) {
            this.page = page;
            axios
                .get(route('api.news.categories.index', {
                    page: page,
                    q : this.q,
                    sort : this.sort.id,
