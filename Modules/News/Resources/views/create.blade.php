                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.news.store') }}">
                                @method('POST')
                                @csrf
                                ...
                                <div class="form-row " style="margin-bottom:  10px">
                                                    ...
                                                    <div class="pt-4">
                                                        ...
                                                        <div class="desciption" >
                                                            <div class="form-group col-md-12 @error("$locale.content") has-danger @enderror">
                                                                ...
                                                                <textarea id="content_name" name="{{ $locale }}[content]" class="form-control" rows="10">{{ old("$locale.content") }}</textarea>
                                    ...
                                    <!-- @include('admin.layout.field', field('file', 'image', 'Main Image Image (210px x 200px)', 12)) -->
