            ...
            <div class="row">
                ...
                <div class="col-md-1 col-sm-3 mb-1">
                    <div class="input-group  d-xl-inline-flex">
                        <a class="btn btn-success" :href="route('admin.Casing-categories.create')" title="New"><i class="la la-plus"></i></a>
                    </div>
                </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" :href="route('admin.Casing-categories.edit', {Casing_category: category.id, Casing_category: category})">Edit</a>
                                                <a class="dropdown-item" :href="route('admin.Casing-categories.delete', {CasingCategory: category.id, CasingCategory: category})">Deleted</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
export default {
    ...
    methods: {
        fetchCategories(page = 1) {
            this.page = page;
            axios
                .get(route('api.Casing.categories.index', {
                    page: page,
                    q : this.q,
                    sort : this.sort.id,
