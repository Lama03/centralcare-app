                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.Casings.store') }}">
                                @method('POST')
                                @csrf
                                <div class="form-row" style="margin-bottom:  10px">
                                    ...
                                    <div class="form-group col-md-6 @error('image_before') has-danger @enderror">
                                        ...
                                        <input type="file" name="image_before" class="dropify" data-height="200" data-default-file=""/>
                                    ...
                                    <div class="form-group col-md-6 @error('image_after') has-danger @enderror">
                                        ...
                                        <input type="file" name="image_after" class="dropify" data-height="200" data-default-file=""/>
