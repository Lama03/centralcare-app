            ...
            <div class="row">
                ...
                <div class="col-md-1 col-sm-3 mb-1">
                    <div class="input-group  d-xl-inline-flex">
                        <a class="btn btn-success" :href="route('admin.testimonials.create', {page: page})" title="New"><i class="la la-plus"></i></a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md text-small">
                            ...
                            <tbody>
                                <tr v-for="testimonial in testimonials.data">
                                    <td><strong>{{ testimonial.id }}</strong></td>
                                    <td>{{ testimonial.name }}</td>
                                    <td>
                                        <span v-bind:class="{ 'badge-success' : (testimonial.status === 2) , 'badge-light' : (testimonial.status === 1) }" class="badge">{{ testimonial.statusLabel }}</span>
                                    </td>
                                    <td>{{ moment(testimonial.created_at).format('DD MMM YYYY, hh:mm A') }}</td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" :href="route('admin.testimonials.edit', {testimonial: testimonial.id, page: page})">Edit</a>
                                                <a class="dropdown-item" :href="route('admin.testimonials.enable', {testimonial: testimonial.id, page: page})">Enable</a>
                                                <a class="dropdown-item" :href="route('admin.testimonials.disable', {testimonial: testimonial.id, page: page})">Disable</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
