...
<html lang="en">
    <head>
        ...
        <script src="https://cdn.tiny.cloud/1/9olqxf2r66w2oxn8wlewtfhzxrlo74dangkzcwlb73eiuo08/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
        ...
        ***********************************-->
        <div id="main-wrapper">
            ...
            ***********************************-->
            <div class="nav-header">
                <a href="{{ route('admin.dashboard.index') }}" class="brand-logo">
                    <img class="logo-abbr" src="/assets/images/central_care_logo.png" alt="">
                </a>
            ...
            ***********************************-->
            ...
            <div class="footer">
                <div class="copyright">
                    <p>Copyright © Designed &amp; Developed by central medical care {{ date('Y') }}</p>
                </div>
            </div>
            <!--**********************************
                Footer end
