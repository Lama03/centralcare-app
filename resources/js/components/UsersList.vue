                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" :href="route('admin.users.enable', {user: user.id, page: page})">Enable</a>
                                                <a class="dropdown-item" :href="route('admin.users.disable', {user: user.id, page: page})">Disable</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
